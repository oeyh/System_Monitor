...
Udacity Cpp ND course project - System Monitor
System Monitor Project in the C++ OOP course.
Starter code from: https://github.com/udacity/CppND-System-Monitor

`ProcessParser` and `Process` classes have the major work.
